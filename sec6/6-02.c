...
// {
// 	struct node *nodep;
// 	char         firstchar, word[MAXWORD];
// 	int          n;

// 	if (argc == 1)
// 	{
// 		printf("Usage: command [number of words]\n");
// 		return 0;
// 	}
// 	n = atoi(argv[1]);
// 	nodep = NULL;
// 	while ((firstchar = getword(word, MAXWORD)) != EOF)
// 	{
// 		if (isalpha(word[0]))
// 		{
// 			nodep = addtree(nodep, word);
// 		}
// 	}
// 	printtree(nodep);
// 	printf("\n");
...
// char *strdmp(char *word)
// {
// 	char *d;

// 	d = (char *) malloc(strlen(word) + 1);
// 	if (d != NULL)
// 	{
// 		strcpy(d, word);
// 	}
